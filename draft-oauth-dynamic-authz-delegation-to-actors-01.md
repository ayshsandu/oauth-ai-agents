...
See the Error Codes section for the complete list of error codes applicable to the authorization and PAR endpoints.
...
## Authorization Server Validation (Token Endpoint)
...
See the Error Codes section for the complete list of error codes applicable to the token endpoint.
...
# Resource Server Behavior and Dynamic Consent
